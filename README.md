...
// config/omnicron.php
'tasks' => [
    App\CronJobs\PurgeSessions::class,
    App\CronJobs\CloseBillingCycles::class,
],
```
...
|---|---|
| `omnicron:task {Name}` | Scaffold a new task class (into `task_namespace`, default `App\CronJobs`) |
